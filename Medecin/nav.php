...
<header class="clearfix">
    ...
    <nav class="navbar navbar-default navbar-static-top tm_navbar clearfix" role="navigation">
        <div class="container">
            ...
            <li class="active"><a href="../acc_med_auth.html">Accueil Médecin</a></li>
                    <li><a href="MesReservationMedecin.php">RÉSERVATIONS PATIENTS</a></li>
                    <li><a href="AfficherPublication.php">Mes Postes</a></li>
                    <li><a href="MesReservationMedecin.php">Mes RÉSERVATIONS </a></li>
                    <li class="index-4.htm"><a href="/PROJET/send_message.php">ACCÈS RDV VISIO</a>
                    <li><a href="/PROJET/info_mala_med.php">INFORMATIONS MALADIES</a></li>
